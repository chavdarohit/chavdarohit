...
<h2 dir="auto"><a id="user-content-projects" class="anchor" aria-hidden="true" href="#projects"><svg
        ...
        <ul dir="auto">
            <li><a href="https://github.com/chavdarohit/Notes-app-react">Notes App (React with Localstorage)</a>: A notes recording app made with ReactJs(Learning Purpose)</li>
            <li><a href="https://github.com/chavdarohit/Student-details-react">Student Details App (React with Firebase)</a>: A Student detail storing app made with ReactJs and Firebase</li>
            <li><a href="https://github.com/chavdarohit/Finance-Tracking-Android">Finance Tracker via SMS (Android studio with Firebase)</a>:The app serves as a tool for managing finances and staying organized with tasks and reminders.</li>
            <li><a href="https://github.com/chavdarohit/Student-details-react">Saree Store app(Android studio with Firebase)</a>:The live app serves as a data recording application or entry recording of bills about the store.</li>            
          </ul>
